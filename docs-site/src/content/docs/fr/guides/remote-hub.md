...
```bash
# N'importe quel relais TCP local convient; socat en est un. L'écoute de données est liée
# à l'adresse tailnet, donc 127.0.0.1:10100 reste libre pour le relais.
...
tailscale serve status   # les deux mappages attendus : 443 -> 10101 et 8443 -> 10100
```
