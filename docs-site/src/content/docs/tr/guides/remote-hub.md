...
```bash
# Herhangi bir loopback TCP yönlendirici iş görür; socat bunlardan biridir. Veri dinleyicisi
# tailnet adresine bağlı olduğundan 127.0.0.1:10100 yönlendiricinin kullanımına açıktır.
...
tailscale serve status   # iki eşleme de beklenir: 443 -> 10101 ve 8443 -> 10100
```
